...
function Hero() {
  return (
    <section className='hero-section'>
        ...
        <img src='/images/hero-bg.webp'alt="backround" className='scale-out'/>
        ...
        <div>
            <img src="/imges/big-hero-text.svg" alt="logo" className='size-full object-cover mask-logo' />
        </div>
        <div calssName='fake-logo-wrapper'>
